...
try:
    ...
    CREATE TABLE IF NOT EXISTS estados_alquiler (
        id_estado_alq INTEGER PRIMARY KEY AUTOINCREMENT,
        codigo TEXT NOT NULL UNIQUE,
        activo BOOLEAN NOT NULL DEFAULT 1
    );

    CREATE TABLE IF NOT EXISTS estados_reserva (
        id_estado_res INTEGER PRIMARY KEY AUTOINCREMENT,
        codigo TEXT NOT NULL UNIQUE,
        activo BOOLEAN NOT NULL DEFAULT 1
    );

    CREATE TABLE IF NOT EXISTS estados_mantenimiento (
        id_estado_man INTEGER PRIMARY KEY AUTOINCREMENT,
        codigo TEXT NOT NULL UNIQUE,
        activo BOOLEAN NOT NULL DEFAULT 1
    );

    CREATE TABLE IF NOT EXISTS estados_incidente (
        id_estado_inc INTEGER PRIMARY KEY AUTOINCREMENT,
        codigo TEXT NOT NULL UNIQUE,
        activo BOOLEAN NOT NULL DEFAULT 1
    );
    ...
    CREATE TABLE IF NOT EXISTS tipos_incidente (
        ...
        codigo TEXT NOT NULL UNIQUE,
        requiere_monto BOOLEAN NOT NULL DEFAULT 0,
        afecta_seguro BOOLEAN NOT NULL DEFAULT 0,
        activo BOOLEAN NOT NULL DEFAULT 1
    );
    ...
    CREATE TABLE IF NOT EXISTS mantenimientos (
        ...
        FOREIGN KEY (estado_mantenimiento_id) REFERENCES estados_mantenimiento(id_estado_man),
    ...
    CREATE TABLE IF NOT EXISTS reservas (
        ...
        FOREIGN KEY (vehiculo_id) REFERENCES vehiculos(id_vehiculo),
        FOREIGN KEY (empleado_id) REFERENCES empleados(id_empleado),
        FOREIGN KEY (estado_reserva_id) REFERENCES estados_reserva(id_estado_res)
    );
    ...
    CREATE TABLE IF NOT EXISTS incidentes (
        ...
        FOREIGN KEY (estado_incidente_id) REFERENCES estados_incidente(id_estado_inc),
        FOREIGN KEY (empleado_id) REFERENCES empleados(id_empleado)
    );
    """)
