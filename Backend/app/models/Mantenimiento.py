class Mantenimiento:
    def __init__(self, vehiculo, empleado, estado_mantenimiento_id, tipo, fecha_programada=None, fecha_realizada=None, km=0, costo=0, notas=None, id_mantenimiento=None):
        self.id_mantenimiento = id_mantenimiento
        self.vehiculo = vehiculo
        self.empleado = empleado
        self.estado_mantenimiento_id = estado_mantenimiento_id
        self.tipo = tipo
    ...
    def to_dict(self):
        return {
            ...
            "estado_mantenimiento_id": self.estado_mantenimiento_id,
            "tipo": self.tipo,
    ...
    @classmethod
    def from_dict(cls, data, vehiculo=None, empleado=None):
        return cls(
            vehiculo=vehiculo,
            empleado=empleado,
            estado_mantenimiento_id=data.get("estado_mantenimiento_id"),
            tipo=data.get("tipo"),
